...
public class UserService {
    ...
    public ResponseEntity<RegisterRequestDTO> getCustomer(Authentication authentication) {
    ...
    public ResponseEntity<MessageResponseDTO> updateCustomer(Authentication authentication, @RequestBody RegisterRequestDTO customerFields) {
        Optional<Customer> optionalCustomer = customerRepository.findByEmail(authentication.getName());
        if (optionalCustomer.isEmpty()) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(null);
        }
