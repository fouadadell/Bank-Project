...
public class AccountService {
   ...
   public ResponseEntity<AccountDetailsDTO> getAccount(Authentication authentication, String accountNumber) {
    ...
    public ResponseEntity<List<AccountTransactionsDTO>> getAccountTransactions(Authentication authentication, String accountNumber) {
        Optional<Customer> customer = customerRepository.findByEmail(authentication.getName());
